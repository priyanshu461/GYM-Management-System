...
const BMICalculator = () => {
  ...
  return (
    <Layout>
      <div className="p-6 max-w-7xl mx-auto bg-gradient-to-br from-teal-50 via-slate-50 to-teal-100 min-h-screen">
        ...
        <div className="grid lg:grid-cols-3 gap-8 mb-8">
          ...
          <div className="lg:col-span-1 space-y-6">
            <motion.div
              className="bg-gradient-to-br from-teal-100 to-teal-200 p-6 rounded-3xl shadow-xl border border-teal-300"
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            {bmi && (
              <motion.div
                className="bg-gradient-to-br from-teal-100 to-teal-200 p-6 rounded-3xl shadow-lg border border-teal-300"
            ...
            {/* Progress Tracker */}
            {bmi && (
              <div className="bg-gradient-to-br from-teal-100 to-teal-200 p-6 rounded-3xl shadow-lg">
          ...
          <div className="mb-8">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {dietPlan.map((plan, index) => (
                <div
                  key={index}
                  className="p-6 rounded-3xl bg-gradient-to-br from-teal-100 to-teal-200 shadow-lg hover:shadow-xl transition"
                >
                  <h3 className="font-bold text-teal-900 text-xl mb-2">
                    {plan.meal}
                  </h3>
                  <p className="text-slate-700 mb-3">{plan.items}</p>
            ...
            <div className="mt-6 p-4 bg-teal-200 rounded-2xl">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {workoutPlan.map((plan, index) => (
                ...
                >
                  ...
                  <p className="text-slate-700 mb-3">{plan.exercises}</p>
                  <p className="text-sm text-teal-600 font-semibold">
