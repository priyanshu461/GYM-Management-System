...
const products = [
  ...
  },
  {
    ...
    price: "₹1,499",
    image:
      "https://encrypted-tbn3.gstatic.com/shopping?q=tbn:ANd9GcSypNEfAvIC1EUqM47UGCnYVCypP7-sVJxvY0NtFxd2Ng05FgJUwCzuLZQU5gGWj0-bTLAxWzOsUto7E200xaUipKPc1uKwTHjq6teU9cJMeVnFVTVx_IYUG9dc9doQQpVi3cYSxw&usqp=CAc",
    rating: 4.3,
    flavor: "Fruit Punch",
  },
  {
    ...
    price: "₹999",
    image:
      "https://i0.wp.com/promptnutrition.com/wp-content/uploads/2023/12/img_0974.png?w=414&ssl=1",
    rating: 4.7,
    flavor: "Unflavored",
  },
  {
    ...
    price: "₹3,299",
    image:
      "https://nutrabox.in/cdn/shop/files/Vegan_Banner_M.jpg?crop=center&height=1200&v=1748589953&width=1200",
    rating: 4.4,
    flavor: "Vanilla",
  },
  {
    ...
    price: "₹1,799",
    image:
      "https://encrypted-tbn2.gstatic.com/shopping?q=tbn:ANd9GcRnPRZjPJRJCvGcKIei09s6if3PuULmnCFmMk8IxCfg_fEXnKwXL_YQy33drsOp4H3UMAi_CUlTTaf4KqaNbWhXZ-0_DgCTG4wVVy_b6ubJclQxGNbB1hIyolZHng0tfiEBWtcpKWXu&usqp=CAc",
    rating: 4.1,
  ...
  },
  {
    ...
    price: "₹2,599",
    image:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRlZNCQ3DXLPzV5opN9WZjKvKLIMoY48taB2g&s",
    rating: 4.6,
    flavor: "Chocolate",
  },
  {
    ...
    price: "₹3,499",
    image:
      "https://images-cdn.ubuy.co.in/678c657ddd32e911176e3409-optimum-nutrition-platinum-hydrowhey.jpg",
    rating: 4.8,
    flavor: "Strawberry",
  },
  {
    ...
    price: "₹899",
    image:
      "https://proathlix.com/cdn/shop/files/2NewProteinBarSlides.png?v=1755581600&width=720",
    rating: 4.0,
    flavor: "Mixed",
  },
  {
    ...
    price: "₹1,299",
    image:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS2fMHotvoeI8unfvLiqZDiiLtVfNHL0c2z4g&s",
    rating: 4.2,
    flavor: "Unflavored",
  },
];
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
          ...
          <button
            ...
            className="bg-gradient-to-r from-teal-500 to-emerald-500 hover:from-teal-400 hover:to-emerald-400 px-6 py-3 rounded-xl font-semibold text-white shadow-lg shadow-teal-500/40 hover:shadow-teal-500/60 hover:scale-105 transition-all duration-300"
          >
            Add New Product
          </button>
        </div>
